...
export class TokenizeProtocolUpgraded extends ethereum.Event {
  get params(): TokenizeProtocolUpgraded__Params {
    return new TokenizeProtocolUpgraded__Params(this);
  }
}

export class TokenizeProtocolUpgraded__Params {
  _event: TokenizeProtocolUpgraded;

  constructor(event: TokenizeProtocolUpgraded) {
    this._event = event;
  }
...
export class Factory extends ethereum.SmartContract {
  ...
  Tokenizeimplementation(): Address {
  ...
  try_Tokenizeimplementation(): ethereum.CallResult<Address> {
  ...
  getERC1155Collateral(tokenizeAddress: Address): Address {
    let result = super.call(
      "getERC1155Collateral",
      "getERC1155Collateral(address):(address)",
      [ethereum.Value.fromAddress(tokenizeAddress)]
    );
  ...
  getERC721Collateral(tokenizeAddress: Address): Address {
    let result = super.call(
      "getERC721Collateral",
  ...
  getTokenizeAddress(_tokenId: BigInt): Address {
    let result = super.call(
      "getTokenizeAddress",
      "getTokenizeAddress(uint256):(address)",
  ...
  try_getTokenizeAddress(_tokenId: BigInt): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "getTokenizeAddress",
      "getTokenizeAddress(uint256):(address)",
      [ethereum.Value.fromUnsignedBigInt(_tokenId)]
  ...
  getTokenizesLength(): BigInt {
    let result = super.call(
      "getTokenizesLength",
      "getTokenizesLength():(uint256)",
      []
    );
  ...
  try_getTokenizesLength(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "getTokenizesLength",
      "getTokenizesLength():(uint256)",
      []
...
export class SetTokenizeImplementationCall extends ethereum.Call {
  get inputs(): SetTokenizeImplementationCall__Inputs {
    return new SetTokenizeImplementationCall__Inputs(this);
  }

  get outputs(): SetTokenizeImplementationCall__Outputs {
    return new SetTokenizeImplementationCall__Outputs(this);
  }
}

export class SetTokenizeImplementationCall__Inputs {
  _call: SetTokenizeImplementationCall;

  constructor(call: SetTokenizeImplementationCall) {
    this._call = call;
  }
...
export class SetTokenizeImplementationCall__Outputs {
  _call: SetTokenizeImplementationCall;
