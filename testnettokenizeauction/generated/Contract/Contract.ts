...
export class TokenizeClaimed extends ethereum.Event {
  get params(): TokenizeClaimed__Params {
    return new TokenizeClaimed__Params(this);
  }
}

export class TokenizeClaimed__Params {
  _event: TokenizeClaimed;

  constructor(event: TokenizeClaimed) {
    this._event = event;
  }
...
export class ClaimTokenizeCall extends ethereum.Call {
  get inputs(): ClaimTokenizeCall__Inputs {
    return new ClaimTokenizeCall__Inputs(this);
  }

  get outputs(): ClaimTokenizeCall__Outputs {
    return new ClaimTokenizeCall__Outputs(this);
  }
}

export class ClaimTokenizeCall__Inputs {
  _call: ClaimTokenizeCall;

  constructor(call: ClaimTokenizeCall) {
    this._call = call;
  }
...
export class ClaimTokenizeCall__Outputs {
  _call: ClaimTokenizeCall;
...
export class ExportTokenizeCall extends ethereum.Call {
  get inputs(): ExportTokenizeCall__Inputs {
    return new ExportTokenizeCall__Inputs(this);
  }

  get outputs(): ExportTokenizeCall__Outputs {
    return new ExportTokenizeCall__Outputs(this);
  }
}

export class ExportTokenizeCall__Inputs {
  _call: ExportTokenizeCall;

  constructor(call: ExportTokenizeCall) {
    this._call = call;
  }
...
export class ExportTokenizeCall__Outputs {
  _call: ExportTokenizeCall;
...
export class ImportTokenizeCall extends ethereum.Call {
  get inputs(): ImportTokenizeCall__Inputs {
    return new ImportTokenizeCall__Inputs(this);
  }

  get outputs(): ImportTokenizeCall__Outputs {
    return new ImportTokenizeCall__Outputs(this);
  }
}

export class ImportTokenizeCall__Inputs {
  _call: ImportTokenizeCall;

  constructor(call: ImportTokenizeCall) {
    this._call = call;
  }
...
export class ImportTokenizeCall__Outputs {
  _call: ImportTokenizeCall;
