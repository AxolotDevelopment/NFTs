...
export function handleDeployed(event: Deployed): void {
  ...
  entity.address = "0x0098C5c96946c404261bd0F542212CEf66FE9320";
  entity.save();
  Factory.create(Address.fromString("0x0098C5c96946c404261bd0F542212CEf66FE9320"));
}

export function handleFeeUpdated(event: FeeUpdated): void {}

export function handleTokenizeClaimed(event: TokenizeClaimed): void {}
